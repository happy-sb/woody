...
import happy2b.profiling.agct.resource.fetch.inst.InstResourceFetcher;
import happy2b.profiling.agct.resource.fetch.jni.JNIResourceFetcher;
...
//        InstResourceFetcher.INSTANCE.bootstrap();
        JNIResourceFetcher.INSTANCE.bootstrap();
